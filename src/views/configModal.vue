        ...
        <div class="modal-body px-0" style="display: flex">
          ...
          >
            ...
            <li class="nav-item" role="presentation">
              <button
                class="nav-link"
                id="config-behavior-tab"
                data-bs-toggle="tab"
                data-bs-target="#config-behavior"
                role="tab"
              >
                Behavior
              </button>
          ...
          >
            <div class="tab-pane fade active show" id="config-general">
              <div class="d-flex flex-column mt-2 h-100">
                <div
                  class="form-check form-switch d-flex px-1 mb-3 justify-content-between"
                >
                  <label
                ...
                >
                  ...
                  <input
                    ...
                    v-model="configData.checkUpdates"
                    @change="
                      changeConfig('checkUpdates', configData.checkUpdates)
                    "
                  />
                </div>
                ...
                >
                  ...
                  <input
                    ...
                    type="checkbox"
                    id="openOnStartup"
                    v-model="configData.openOnStartup"
                ...
                >
                    ...
                    <span>
                      ...
                      <sup>
                        <i
                          ...
                          style="cursor: help"
                          :title="$t('settings.runInBackgroundInfo')"
                        >
                        </i>
                      </sup>
                    </span>
                  ...
                  <input
                    ...
                    type="checkbox"
                    id="runInBackground"
                    v-model="configData.runInBackground"
                ...
                >
                  <label
                    class="form-check-label flex-fill"
                    for="reportErrors"
                    >{{ $t("settings.reportErrors") }}</label
                  >
                  <input
                    class="form-check-input"
                    type="checkbox"
                    id="reportErrors"
                    v-model="configData.reportErrors"
              ...
              <div class="d-flex flex-column mt-2 h-100">
                ...
                >
                  <label
                    class="form-check-label flex-fill"
                    for="moveOldTasks"
                    >{{ $t("settings.moveOldTasks") }}</label
                  >
                  <input
                    class="form-check-input"
                    type="checkbox"
                    id="moveOldTasks"
                    v-model="configData.moveOldTasks"
                    @change="
                      changeConfig('moveOldTasks', configData.moveOldTasks)
                    "
                  />
                </div>
                <div
                ...
                >
                  <label
                    class="form-check-label flex-fill"
                    for="weekStartOnMonday"
                    >{{ $t("settings.weekStartOnMonday") }}</label
                  >
                  <input
                    class="form-check-input"
                    type="checkbox"
                ...
                >
                  <label
                    class="form-check-label flex-fill"
                    for="moveOldTasks"
                    >{{ $t("settings.startCalendarYesterday") }}</label
                  >
                  <input
                    class="form-check-input"
                    type="checkbox"
                    ...
                    @change="
                      changeConfig(
                        ...
                        configData.startCalendarYesterday
                      )
                    "
                  />
                </div>
                ...
                >
                  <label
                    class="form-check-label flex-fill"
                    for="autoReorderTasks"
                    >{{ $t("settings.autoReorderTasks") }}</label
                  >
                  <input
                    class="form-check-input"
                    type="checkbox"
                ...
                >
                  <label
                    ...
                    >{{ $t("settings.moveCompletedTaskToBottom") }}</label
                  >
                  <input
                    class="form-check-input"
                    type="checkbox"
                    ...
                    @change="
                      changeConfig(
                        ...
                        configData.moveCompletedTaskToBottom
                      )
                    "
                  />
                </div>
                ...
                >
                  <label
                    ...
                    >{{ $t("settings.moveCompletedSubTaskToBottom") }}</label
                  >
                  <input
                    class="form-check-input"
                    type="checkbox"
                    ...
                    @change="
                      changeConfig(
                        ...
                        configData.moveCompletedSubTaskToBottom
                      )
                    "
                  />
                </div>
                ...
                >
                  <label
                    class="form-check-label flex-fill"
                    for="autoCompleteTaskWhenAllSubtasksAreDone"
                    >{{
                      $t("settings.autoCompleteTaskWhenAllSubtasksAreDone")
                    }}</label
                  >
                  <input
                    class="form-check-input"
                    type="checkbox"
                    id="autoCompleteTaskWhenAllSubtasksAreDone"
                    v-model="configData.autoCompleteTaskWhenAllSubtasksAreDone"
                    @change="
                      changeConfig(
                        'autoCompleteTaskWhenAllSubtasksAreDone',
                        configData.autoCompleteTaskWhenAllSubtasksAreDone
                      )
                    "
                  />
                </div>
              ...
              <div class="d-flex flex-column mt-2 h-100">
                ...
                >
                  ...
                  <input
                    ...
                    type="checkbox"
                    id="darkTrayIcon"
                    v-model="configData.darkTrayIcon"
                ...
                <div class="px-1 mb-3">
                  ...
                  <input
                    ...
                    @change="changeConfig('columns', configData.columns)"
                  />
                </div>

                <div class="px-1 mb-3">
                  <label for="columnsConfig" class="form-check-label"
                    >{{ $t("settings.lists_columns") }}:
                    {{ configData.customColumns }}</label
                  >
                  <input
                    type="range"
                    class="form-range mt-2 px-2"
                    ...
                    @change="
                      changeConfig('customColumns', configData.customColumns)
                    "
                  />
                </div>
                ...
                <div class="px-1 mb-3 zoom-config">
                  <label for="zoomConfig" class="form-check-label"
                    >{{ $t("settings.zoom") }}: {{ configData.zoom }}%</label
                  >
                  <input
                    type="range"
                    class="form-range mt-2 px-2"
                    ...
                    id="zoomConfig"
                    step="5"
                    v-model="configData.zoom"
                    @change="changeConfig('zoom', configData.zoom)"
                  />
                </div>
                ...
                >
                  ...
                  <input
                    ...
                    @change="
                      changeConfig('compactView', configData.compactView)
                    "
                  />
                </div>
                <div
                ...
                >
                  ...
                  <input
                    ...
                    @change="
                      changeConfig(
                        'fullscreenToDoModal',
                        configData.fullscreenToDoModal
                      )
                    "
                  />
                </div>
            ...
            <div class="tab-pane fade" id="config-notifications">
              <div class="d-flex flex-column mt-3 h-100">
                  ...
                  <input
                    ...
                    @change="
                      changeConfig(
                        ...
                        configData.notificationOnStartup
                      )
                    "
                  />
                </div>
                ...
                <div
                  class="form-check form-switch d-flex px-0 mb-3 justify-content-between"
                >
                  <label
                    class="form-check-label"
                    style="margin-left: 0px"
                    for="notificationIndicator"
                    >{{ $t("settings.notificationIndicator") }}</label
                  >
                  <input
                    class="form-check-input"
                    type="checkbox"
                    ...
                    @change="
                      changeConfig(
                        ...
                        configData.notificationIndicator
                      )
                    "
                  />
                </div>
                ...
                <div class="d-flex">
                  <select
                    ...
                    v-model="configData.notificationSound"
                    @change="
                      changeConfig(
                        'notificationSound',
                        configData.notificationSound
                      )
                    "
                  >
            ...
            <div class="tab-pane fade" id="config-data">
              <div class="d-flex flex-column mt-2 h-100">
                <div>
                  <div>
                    <div
                      class="form-check form-switch d-flex px-1 mb-3 justify-content-between align-items-center"
                    >
                      <label class="form-check-label" for="export-data-btn">{{
                    ...
                    <div
                      class="form-check form-switch d-flex px-1 mb-3 justify-content-between align-items-center"
                    >
                      <label class="form-check-label" for="import-data-btn">{{
                    ...
                    <div
                      class="form-check form-switch d-flex px-1 mb-3 justify-content-between align-items-center"
                    >
                      <label class="form-check-label" for="clear-data-btn">{{
...
export default {
  ...
  methods: {
    ...
    exportData: function () {
      let configModal = Modal.getInstance(
        document.getElementById("configModal")
      );
      configModal.hide();
      let exportingModal = new Modal(
    ...
    setLanguage: function () {
      ...
      this.$nextTick(function () {
        if (this.isElectron()) {
          const { ipcRenderer } = require("electron");
          ipcRenderer.send("set-tray-context-menu-label", {
            open: this.$t("ui.open"),
            quit: this.$t("ui.quit"),
          });
        }
